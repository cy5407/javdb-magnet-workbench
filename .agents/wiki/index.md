...
- [central_catalog_and_preflight_deployment](patterns/central_catalog_and_preflight_deployment.md): 跨專案規範孤島、工具目錄分岔與盲目覆寫未回寫代碼 + 缺乏三方基準線比對與執行期硬性攔截 + 採 catalog 中央資產庫、preflight 三方部署閘門與 .agent-hooks 程式化護欄。
